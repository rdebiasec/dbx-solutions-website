import { COMPANY_LEGAL_NAME, LEGAL_EFFECTIVE_DATE, legalContactBlockHtml } from './constants.js'

export function getPrivacyArticleHtml() {
  return `
    <h1>Privacy Policy</h1>
    <p class="legal-effective"><strong>Effective Date: ${LEGAL_EFFECTIVE_DATE}</strong></p>
    <p>${COMPANY_LEGAL_NAME} ("DBX Solutions," "we," "our," or "us") provides CX, automation, and AI-related advisory and implementation services for businesses. We respect your privacy and are committed to handling personal information responsibly.</p>
    ...
    <p>We may retain records of communications when you contact us via forms, email, phone, or SMS.</p>
    ...
    <p>We may maintain records of consent and related communications where required by law or for operational purposes.</p>
